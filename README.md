...
이때, 선택된 아이템들이 속한 모든 트랙이 자동으로 선택됩니다.
...
멀티 트랙 작업 시 작업 효율 향상
사용 방법
Arrange 영역에서 우클릭 드래그로 아이템 선택
선택된 아이템 기준으로 해당 트랙들이 자동 선택됨
🇺🇸 English
Feature Description
...
Usage
Right-drag in the Arrange view to select items
Tracks containing those items will be automatically selected
